...
import static com.example.thiago.alunomapa.WeekViewUtil.*;
import static com.example.thiago.alunomapa.WeekViewUtil.isSameDay;
import static com.example.thiago.alunomapa.WeekViewUtil.today;
...
public class WeekView extends View {
    ...
    private void drawHeaderRowAndEvents(Canvas canvas) {
        ...
        for (int dayNumber = leftDaysWithGaps + 1;
            ...
            //TODO: AJEITAR LINHAS AMPM PARA 24HRS
        ...
        if (mDateTimeInterpreter == null) {
            mDateTimeInterpreter = new DateTimeInterpreter() {
                ...
                public String interpretDate(Calendar date) {
                    try {
                        SimpleDateFormat sdf = mDayNameLength == LENGTH_SHORT ? new SimpleDateFormat("EEEEE dd/M", Locale.getDefault()) : new SimpleDateFormat("EEE dd/M", Locale.getDefault());
